    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          headlineMedium: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.violetPrimary),
          titleLarge: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.violetPrimary),
          titleMedium: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppColors.violetPrimary),
          bodyLarge: TextStyle(fontSize: 12, color: Color(0xFF2C2C2C)),
